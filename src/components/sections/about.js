...
const About = () => {
  ...
  const skills = ['Python', 'C++', 'React', 'Node.js', 'backtrader', 'JUCE'];
      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            {/* <p>
              I’m grateful for my education at UT and to have had the privilege of working at Wells Fargo, not once, not twice, but three times!{' '}
